...
def new_win():
    q=Tk()
    Face_Recognition_System(q)
    q.mainloop()

Frame(w, width=427, height=250, bg='#272727').place(x=0,y=0)
label1=Label(w, text='the HAWKEYE', fg='white', bg='#272727') #decorate it 
...
author=Label(w, text='sreehari & vaishnav', fg='white', bg='#272727') #decorate it 
author.configure(font=("Calibri", 11))
author.place(x=290,y=215)
